...
def mobile(request,data=None):
    if data==None:
        ...
        mobiles = Product.objects.filter(catagory='M').filter(discounted_price__lt=20000)
    elif data=="above":
        mobiles = Product.objects.filter(catagory='M').filter(discounted_price__gt=40000)
